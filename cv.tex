...
\begin{entrylist}
  \entry
    ...
    {\langif{br}{%
         ...
         SRE/DevOps consultant with focus on automation and standardization of
         development environment (CI/CD) and infrastructure on AWS. Cost
         reduction solutions and engineering training (both technical and
         methodological) to \emph{self-service} on the whole pipeline.%
       } \\ %
     \maintechs
     AWS, Jenkins, Github, Packer, Terraform, Docker, shellscript. \\
     \hfill \href{https://kobold.com.br/}{https://kobold.com.br/}%
    }
  \entry
    {\langif{br}{Dez/17 - Now}{Dec/17 - Now}}
  ...
  \entry
    ...
    {\langif{br}{%
         ...
         Data analysis and technology development with the goal of promoting
         better social equity, with excelence, critical thinking and ethic.
       }%
     \hfill%
...
\textbf{python-mode} \hfill \href{https://github.com/python-mode/python-mode}{https://github.com/python-mode/python-mode/}\\
\langif{br}%
{Mantenedor do plugin \emph{python-mode} para vim desde 2017.}%
{Maintainer of the vim plugin \emph{python-mode} since 2017.}\\

\textbf{\langif{br}{Radar Parlamentar}{The Parliamentary Radar}} \hfill \href{https://radarparlamentar.polignu.org/}{https://radarparlamentar.polignu.org/}\\
\langif{br}%
...
\maintechs Django/Python, R, Postgres, nginx, ElasticSearch \eand d3js
